...
<body>
    ...
    <div class="main-content">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="" method="post" id="form" class="needs-validation was-validated ">
                                    ...
                                    <div class="mt-3">
                                        <label class="mb-1">Select Sub Group <span style="color:red;">*</span></label>
                                        <select class="form-control select2" name="subgrp_id" required id="subgrp_id">
                                            <option selected="" disabled="" value="">Choose...</option>
                                            
                                        </select>
                                    </div>
                                    <div class="mt-3">
                                        <label class="mb-1">Details <span style="color:red;">*</span></label>
       ...
       if (isset($_POST['ok'])) {
           ...
           $res  = mysqli_query($conn, $sql);
           if ($res) {
               showSuccessMessage("New Details has been successfully added");
           }
       }
       ?>
